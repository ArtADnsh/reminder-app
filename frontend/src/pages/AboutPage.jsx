  ...
  return (
    <div className="max-w-4xl mx-auto pb-10 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <section className="bg-white rounded-3xl p-8 sm:p-10 shadow-sm border border-gray-100 relative overflow-hidden">
        <div className="absolute top-0 end-0 w-2 h-full bg-primary"></div>
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-2xl font-extrabold text-gray-800">{t('about.title')}</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all group">
            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform origin-end">🎯</div>
            <h4 className="text-lg font-bold text-gray-800 mb-2">{t('about.feature1Title')}</h4>
            <p className="text-gray-500 text-sm leading-relaxed">{t('about.feature1Desc')}</p>
          </div>
          
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all group">
            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform origin-end">🔁</div>
            <h4 className="text-lg font-bold text-gray-800 mb-2">{t('about.feature2Title')}</h4>
            <p className="text-gray-500 text-sm leading-relaxed">{t('about.feature2Desc')}</p>
          </div>
          
          <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:border-primary/30 hover:shadow-md transition-all group">
            <div className="text-4xl mb-4 group-hover:scale-110 transition-transform origin-end">🔔</div>
            <h4 className="text-lg font-bold text-gray-800 mb-2">{t('about.feature3Title')}</h4>
            <p className="text-gray-500 text-sm leading-relaxed">{t('about.feature3Desc')}</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-gray-900 to-secondary rounded-3xl p-8 sm:p-10 shadow-lg text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 end-0 w-64 h-64 bg-white opacity-5 rounded-full -me-20 -mt-20 blur-3xl"></div>
        <div className="absolute bottom-0 start-0 w-40 h-40 bg-primary opacity-20 rounded-full -ms-10 -mb-10 blur-2xl"></div>

        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-10">
          <div className="flex flex-col items-center md:items-start text-center md:text-end">
          ...
          <div className="grid grid-cols-2 gap-4 w-full md:w-auto">
            ...
            >
              ...
              <span className="font-bold">{t('about.github')}</span>
            </a>
            ...
            >
              ...
              <span className="font-bold">{t('about.linkedin')}</span>
            </a>
            ...
            >
              <svg className="w-6 h-6 ps-1" fill="currentColor" viewBox="0 0 24 24"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.15l-9.49 5.97-4.11-1.28c-.89-.28-.91-.89.19-1.32l16.03-6.18c.74-.27 1.39.16 1.15 1.29l-2.73 12.87c-.2.88-.72 1.1-1.46.68l-4.04-2.98-1.95 1.88c-.21.21-.39.39-.8.39l.27-3.87z"/></svg>
              <span className="font-bold">{t('about.telegram')}</span>
            </a>
